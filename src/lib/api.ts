...
export const api = {
  ...
  // Merge the working scenarios into the saved bank (add new / update existing by id).
  upsertScenarios: (scenarios: Scenario[]) =>
    request<{ scenarios: Scenario[]; saved: Scenario[] }>('POST', '/scenarios/upsert', { scenarios }),
