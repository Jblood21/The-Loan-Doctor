...
export default function PreApproval() {
  ...
  const [losMode, setLosMode] = useState<'live' | 'demo'>('demo');
      ...
      <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-[1fr_1.05fr]">
        ...
        <Card className="p-6">
                ...
                <div>
                  <div className="mb-3 flex items-center justify-between rounded-[10px] border border-[rgba(52,211,153,0.25)] bg-[rgba(52,211,153,0.1)] px-3.5 py-2.5">
                    <span className="flex items-center gap-2 text-[13px] font-semibold text-good">
                      ...
                      Connected
                      <span className="font-medium text-text-muted">· {losMode === 'live' ? 'Live' : 'Sandbox'}</span>
                    </span>
          ...
          <div className="mt-3.5">
            <StubNote>
              The letterhead, signature, and contact footer come from Settings. ARIVE is wired in the backend — add your
              ARIVE API token (server env) to pull real borrowers; until then it shows sandbox data. PDF is generated by the backend.
            </StubNote>
          </div>
        </Card>
